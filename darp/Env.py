...
class darpenv():
    ...
    def finish (self):
        ...
        #     if vehicle.free_time >= vehicle.max_route_duration: 
        #         print(vehicle.id, "  ",vehicle.free_time >= vehicle.max_route_duration)
        #         num_finish=+1
        ...
        if len(free_times) == self.num_vehicles:
            ...
            for vehicle in self.vehicles:
                ...
                #self.file.write([term[0] for term in ground_truth])
                print('Prediction:', [term[0] for term in prediction])
                #self.file.write('Prediction: ')
                #self.file.write([term[0] for term in prediction])
